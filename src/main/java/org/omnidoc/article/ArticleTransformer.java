...
import org.omnidoc.xml.XMLFileDocumentReader;
...
public class ArticleTransformer {
	...
	public File transform(){
    	...
    	.process(
    			DocumentReaderSource.forReader(new XMLFileDocumentReader(dataFile)), 
    			FolderTarget.forForder(dataFile.getParentFile())
    	);
